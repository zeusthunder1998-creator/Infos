...
export function BulkAssignModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error(e);
      // v21.3: prefer toast over native alert if available
      const msg = friendlyError(e, 'Could not save changes. Please try again.');
      const t = typeof window !== 'undefined' ? (window as any).__infosToast : null;
      if (typeof t === 'function') t({ message: msg, type: 'error' });
      else alert(msg);
