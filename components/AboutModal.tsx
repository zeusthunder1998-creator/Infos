          ...
          {!editMode && (
            <>
              ...
              <div style={{ border: `1px solid ${C.border}`, borderRadius: '10px', padding: '16px' }}>
                ...
                {/* Privacy Policy link — opens in a new tab so users don't lose
                    their place in the modal/app. Required for Play Store listings. */}
                <div style={{ marginTop: '10px', textAlign: 'center', fontSize: '12px', color: C.textTertiary }}>
