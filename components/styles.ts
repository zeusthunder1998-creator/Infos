...
export const S: Record<string, any> = {
  ...
  label: { display: 'block', fontSize: '12.5px', color: C.textSecondary, marginBottom: '6px', fontWeight: 500, letterSpacing: '-0.005em' },
  btn: { padding: '9px 14px', fontSize: '13.5px', border: `1px solid ${C.borderStrong}`, borderRadius: '9px', background: C.cardBg, cursor: 'pointer', color: C.textPrimary, fontWeight: 500, transition: 'background 0.15s, border-color 0.15s' },
  btnPrimary: { padding: '10px 18px', fontSize: '14px', border: 'none', borderRadius: '9px', background: C.accent, color: 'white', cursor: 'pointer', fontWeight: 600, transition: 'all 0.15s', letterSpacing: '-0.005em' },
  btnDanger: { padding: '6px 10px', fontSize: '12px', border: `1px solid ${C.border}`, borderRadius: '7px', background: 'transparent', color: C.danger, cursor: 'pointer', fontWeight: 500 },
  grid3: { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' },
  grid2: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' },
  empty: { padding: '2.75rem 1rem', textAlign: 'center' as const, color: C.textTertiary, fontSize: '13.5px', background: C.softBg, border: `1px dashed ${C.border}`, borderRadius: '14px' },
  // v25.7: List item — more vertical breathing room, smoother hover via transition.
  item: { padding: '16px 16px 14px', background: C.cardBg, border: `1px solid ${C.border}`, borderRadius: '12px', marginBottom: '12px', display: 'flex', gap: '6px', transition: 'border-color 0.15s, box-shadow 0.15s, transform 0.1s' },
